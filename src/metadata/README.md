 ...
 * [bseo.yml](bseo.yml)
     * Determines how your purl.obolibrary.org/obo/bseo/ redirects will be handled
     ...
     * Paste in the contents of [bseo.yml](bseo.yml)
 ...
 * [bseo.md](bseo.md)
     ...
     * Paste in the contents of [bseo.md](bseo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
